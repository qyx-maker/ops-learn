...
<%
    ...
    try {
        ...
        out.println("<table border='1'><tr><th>ID</th><th>主机名</th><th>状态</th><th>最后更新</th></tr>");
        while (rs.next()) {
            out.println("<tr>");
            out.println("<td>" + rs.getInt("id") + "</td>");
            out.println("<td>" + rs.getString("hostname") + "</td>");
            out.println("<td>" + rs.getString("status") + "</td>");
            out.println("<td>" + rs.getTimestamp("last_update") + "</td>");
            out.println("</tr>");
        }
        out.println("</table>");
    } catch (Exception e) {
